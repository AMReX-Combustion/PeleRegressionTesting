...
test_configuration() {
  ...
  if [ "${COMPILER_NAME}" == 'clang' ]; then
    ...
    CMAKE_CONFIGURE_ARGS="-DPELEC_ENABLE_CPPCHECK:BOOL=ON -DPELEC_ENABLE_CLANG_TIDY:BOOL=ON -DPELEC_ENABLE_SANITIZE:BOOL=ON -DPELEC_ENABLE_FPE_TRAP_FOR_TESTS:BOOL=OFF ${CMAKE_CONFIGURE_ARGS}"
